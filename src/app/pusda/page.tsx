          ...
          <div style={{ background: '#fff', borderRadius: '24px', padding: '3rem 2rem', maxWidth: '400px', width: '100%', textAlign: 'center', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
            ...
            {isPusdaClosed ? (
              <>
                ...
                <h2 style={{ color: '#ef4444', fontWeight: 900, marginBottom: '0.5rem', fontSize: '1.5rem' }}>Akses Portal Tutup</h2>
                <p style={{ color: '#64748b', fontSize: '0.9rem', marginBottom: '2rem', lineHeight: 1.5 }}>
                  Untuk saat ini akses pengisian biodata dan kelengkapan berkas sedang ditutup.
                </p>
                
                <div style={{ marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid #e2e8f0' }}>
                  <p style={{ fontSize: '0.8rem', color: '#64748b', marginBottom: '0.5rem' }}>Untuk kendala dan informasi lebih lanjut hubungi:</p>
                  <a 
                    href="https://wa.me/6285846489366" 
                    target="_blank" 
