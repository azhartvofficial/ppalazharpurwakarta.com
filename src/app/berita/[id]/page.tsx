        ...
        <article className="article-container">
          ...
          <header className="article-header">
            ...
            <div style={{ marginTop: '1.25rem', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              <a 
                href={`https://api.whatsapp.com/send?text=${encodeURIComponent(`Yuk baca berita ini: *${article.judul_utama}*\n\n${pageUrl}`)}`}
                target="_blank" 
                ...
                onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 8px -1px rgba(37, 211, 102, 0.3)'; }}
                onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 6px -1px rgba(37, 211, 102, 0.2)'; }}
              >
