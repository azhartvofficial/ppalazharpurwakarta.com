        ...
        <article className="article-container">
          ...
          <header className="article-header">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '1.2rem' }}>
              <h1 className="article-title" style={{ margin: 0, lineHeight: 1.3 }}>{toTitleCase(article.judul_utama)}</h1>
              ...
              <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'center' }}>
                ...
                <a 
                  href="/template-unduhan"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Unduh Template Berita"
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    boxShadow: '0 4px 6px -1px rgba(255, 140, 0, 0.2), 0 2px 4px -1px rgba(255, 140, 0, 0.1)',
                    transition: 'transform 0.2s, box-shadow 0.2s',
                    flexShrink: 0
                  }}
                  onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 8px -1px rgba(255, 140, 0, 0.3)'; }}
                  onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 6px -1px rgba(255, 140, 0, 0.2)'; }}
                >
